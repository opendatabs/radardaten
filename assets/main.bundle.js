...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_radar_service__ = __webpack_require__("./src/app/shared/radar.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utility_add_records_btn_component__ = __webpack_require__("./src/app/admin/utility/add-records-btn.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_select_coordinates_select_coordinates_component__ = __webpack_require__("./src/app/main/select-coordinates/select-coordinates.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utility_datepicker_component__ = __webpack_require__("./src/app/admin/utility/datepicker.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_auth_service__ = __webpack_require__("./src/app/shared/auth.service.ts");
...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(radarService, authService) {
        ...
        this.selectClick = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        ...
        this.settings = {
            columns: {
                ...
                locationButton: {
                    ...
                    addable: false,
                    editable: false,
                    renderComponent: __WEBPACK_IMPORTED_MODULE_4__main_select_coordinates_select_coordinates_component__["a" /* SelectCoordinatesComponent */],
                ...
                recordsButton: {
                    ...
                    editable: false,
                    addable: false,
                    renderComponent: __WEBPACK_IMPORTED_MODULE_3__utility_add_records_btn_component__["a" /* AddRecordsBtnComponent */],
                    onComponentInitFunction: function (instance) { },
                },
                recordCount: {
                    title: '# Messungen',
    ...
    AdminComponent.prototype.getData = function () {
        ...
        this.radarService.getRadarWithAvgSpeedAndSpeedingQuote()
            .subscribe(function (res) {
            _this.data = res;
            _this.source = new __WEBPACK_IMPORTED_MODULE_2_ng2_smart_table__["b" /* LocalDataSource */](_this.data);
        }, function (err) {
            _this.error = err;
            console.log(err);
        });
    ...
    AdminComponent.prototype.onClearFilter = function () {
        this.source.reset();
        this.filterActive = false;
        __WEBPACK_IMPORTED_MODULE_7_jquery__('#search').val('');
    };
    __decorate([
    ...
    AdminComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_3__utility_add_records_btn_component__["a" /* AddRecordsBtnComponent */],
                __WEBPACK_IMPORTED_MODULE_4__main_select_coordinates_select_coordinates_component__["a" /* SelectCoordinatesComponent */],
                __WEBPACK_IMPORTED_MODULE_5__utility_datepicker_component__["a" /* DatepickerComponent */]
            ]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_radar_service__["a" /* RadarService */],
            __WEBPACK_IMPORTED_MODULE_6__shared_auth_service__["a" /* AuthService */]])
    ], AdminComponent);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddRecordsBtnComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__ = __webpack_require__("./node_modules/@ng-bootstrap/ng-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_radar_service__ = __webpack_require__("./src/app/shared/radar.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_sails_client_service__ = __webpack_require__("./src/app/shared/sails-client.service.ts");
...
var AddRecordsBtnComponent = /** @class */ (function () {
    ...
    AddRecordsBtnComponent.prototype.uploadDocument = function (file) {
        ...
        fileReader.onload = function (e) {
            ...
            _this.error = null;
            _this.sailsClientService.post(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].api + 'record/batchCreate', {
    ...
    AddRecordsBtnComponent.prototype.changePathValue = function (event) {
        ...
        __WEBPACK_IMPORTED_MODULE_3_jquery__('#uploadLabel').html(fileName);
    };
    ...
    AddRecordsBtnComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */],
            __WEBPACK_IMPORTED_MODULE_2__shared_radar_service__["a" /* RadarService */],
            __WEBPACK_IMPORTED_MODULE_4__shared_sails_client_service__["a" /* SailsClientService */],
...
var DatepickerComponent = /** @class */ (function (_super) {
    ...
    function DatepickerComponent() {
        ...
        _this.open = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        __WEBPACK_IMPORTED_MODULE_2_moment__["locale"]('de-ch');
        return _this;
    }
    DatepickerComponent.prototype.ngOnInit = function () {
        ...
        if (this.cell.getValue().length) {
            this.cell.newValue = __WEBPACK_IMPORTED_MODULE_2_moment__().toDate();
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main_map_view_map_view_component__ = __webpack_require__("./src/app/main/map-view/map-view.component.ts");
...
var routes = [
    ...
    { path: 'karte', component: __WEBPACK_IMPORTED_MODULE_2__main_map_view_map_view_component__["a" /* MapViewComponent */] },
    { path: 'admin', component: __WEBPACK_IMPORTED_MODULE_3__admin_admin_component__["a" /* AdminComponent */] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_2__main_map_view_map_view_component__["a" /* MapViewComponent */] },
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__ = __webpack_require__("./node_modules/@ng-bootstrap/ng-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_sails__ = __webpack_require__("./node_modules/angular2-sails/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_sails___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_angular2_sails__);
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        var opts = {
            url: __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].api,
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__angular_router__["a" /* Router */],
            ...
            __WEBPACK_IMPORTED_MODULE_2_angular2_sails__["SailsService"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__main_map_map_component__ = __webpack_require__("./src/app/main/map/map.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__main_map_view_map_view_component__ = __webpack_require__("./src/app/main/map-view/map-view.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__main_map_tooltip_map_tooltip_component__ = __webpack_require__("./src/app/main/map-tooltip/map-tooltip.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_data_service_service__ = __webpack_require__("./src/app/shared/data-service.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_color_service__ = __webpack_require__("./src/app/shared/color.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__main_map_detail_map_detail_component__ = __webpack_require__("./src/app/main/map-detail/map-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__main_d3graph_d3graph_component__ = __webpack_require__("./src/app/main/d3graph/d3graph-component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__shared_radar_service__ = __webpack_require__("./src/app/shared/radar.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__shared_record_service__ = __webpack_require__("./src/app/shared/record.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_ng2_smart_table__ = __webpack_require__("./node_modules/ng2-smart-table/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__main_select_coordinates_select_coordinates_component__ = __webpack_require__("./src/app/main/select-coordinates/select-coordinates.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__admin_utility_add_records_btn_component__ = __webpack_require__("./src/app/admin/utility/add-records-btn.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__shared_calculator_service__ = __webpack_require__("./src/app/shared/calculator.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__admin_utility_datepicker_component__ = __webpack_require__("./src/app/admin/utility/datepicker.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25_angular_font_awesome__ = __webpack_require__("./node_modules/angular-font-awesome/dist/angular-font-awesome.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__shared_sails_client_service__ = __webpack_require__("./src/app/shared/sails-client.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27_angular2_sails__ = __webpack_require__("./node_modules/angular2-sails/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27_angular2_sails___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_27_angular2_sails__);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__main_map_map_component__["a" /* MapComponent */],
                __WEBPACK_IMPORTED_MODULE_7__main_map_view_map_view_component__["a" /* MapViewComponent */],
                __WEBPACK_IMPORTED_MODULE_9__main_map_tooltip_map_tooltip_component__["a" /* MapTooltipComponent */],
                __WEBPACK_IMPORTED_MODULE_13__main_map_detail_map_detail_component__["a" /* MapDetailComponent */],
                __WEBPACK_IMPORTED_MODULE_14__main_d3graph_d3graph_component__["a" /* D3graphComponent */],
                __WEBPACK_IMPORTED_MODULE_16__admin_admin_component__["a" /* AdminComponent */],
                __WEBPACK_IMPORTED_MODULE_20__main_select_coordinates_select_coordinates_component__["a" /* SelectCoordinatesComponent */],
                __WEBPACK_IMPORTED_MODULE_22__admin_utility_add_records_btn_component__["a" /* AddRecordsBtnComponent */],
                __WEBPACK_IMPORTED_MODULE_24__admin_utility_datepicker_component__["a" /* DatepickerComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_19_ng2_smart_table__["c" /* Ng2SmartTableModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_27_angular2_sails__["SailsModule"].forRoot()
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_10__shared_data_service_service__["a" /* DataService */],
                __WEBPACK_IMPORTED_MODULE_11__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_12__shared_color_service__["a" /* ColorService */],
                __WEBPACK_IMPORTED_MODULE_15_d3_ng2_service__["a" /* D3Service */],
                __WEBPACK_IMPORTED_MODULE_17__shared_radar_service__["a" /* RadarService */],
                __WEBPACK_IMPORTED_MODULE_18__shared_record_service__["a" /* RecordService */],
                __WEBPACK_IMPORTED_MODULE_23__shared_calculator_service__["a" /* CalculatorService */],
                __WEBPACK_IMPORTED_MODULE_26__shared_sails_client_service__["a" /* SailsClientService */],
                __WEBPACK_IMPORTED_MODULE_28__shared_auth_service__["a" /* AuthService */],
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment__ = __webpack_require__("./node_modules/moment/moment.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_color_service__ = __webpack_require__("./src/app/shared/color.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var D3graphComponent = /** @class */ (function () {
    ...
    D3graphComponent.prototype.updateChart = function () {
        ...
        self.rects
            ...
            if (self.groupBy === 'days') {
                return self.xScale(__WEBPACK_IMPORTED_MODULE_2_moment__(d.date).format('dddd')) + self.padding;
            }
            else {
    ...
    D3graphComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"],
            ...
            __WEBPACK_IMPORTED_MODULE_3__shared_color_service__["a" /* ColorService */]])
    ], D3graphComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_record_service__ = __webpack_require__("./src/app/shared/record.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_color_service__ = __webpack_require__("./src/app/shared/color.service.ts");
...
var MapDetailComponent = /** @class */ (function () {
    ...
    MapDetailComponent.prototype.getMeasurementsForWeek = function () {
        ...
        var direction;
        (this.directionOne) ? direction = 1 : direction = 2;
        this.recordService.getRecordsForWeeklyView(this.radar.id, direction, __WEBPACK_IMPORTED_MODULE_3_moment__(this.selectedMeasurement.startDay).format('YYYY-MM-DD'), __WEBPACK_IMPORTED_MODULE_3_moment__(this.selectedMeasurement.startDay).add(7, 'day').format('YYYY-MM-DD')).subscribe(function (data) {
    ...
    MapDetailComponent.prototype.openDailyView = function (weeklyRecord) {
        var _this = this;
        this.dailyHeader = __WEBPACK_IMPORTED_MODULE_3_moment__(weeklyRecord.date).format('dddd');
        this.dailyHeader += ' (' + __WEBPACK_IMPORTED_MODULE_3_moment__(weeklyRecord.date).format('DD.MM.YYYY') + ')';
        var direction;
        (this.directionOne) ? direction = 1 : direction = 2;
        this.recordService.getRecordsForDailyView(this.radar.id, direction, __WEBPACK_IMPORTED_MODULE_3_moment__(weeklyRecord.date).format('YYYY-MM-DD'), __WEBPACK_IMPORTED_MODULE_3_moment__(weeklyRecord.date).add(1, 'day').format('YYYY-MM-DD')).subscribe(function (data) {
    ...
    MapDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_record_service__["a" /* RecordService */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["ApplicationRef"],
            __WEBPACK_IMPORTED_MODULE_2__shared_color_service__["a" /* ColorService */]])
    ], MapDetailComponent);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MapTooltipComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_color_service__ = __webpack_require__("./src/app/shared/color.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MapTooltipComponent = /** @class */ (function () {
    ...
    MapTooltipComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_color_service__["a" /* ColorService */]])
    ], MapTooltipComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__map_detail_map_detail_component__ = __webpack_require__("./src/app/main/map-detail/map-detail.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_radar_service__ = __webpack_require__("./src/app/shared/radar.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MapViewComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1__map_detail_map_detail_component__["a" /* MapDetailComponent */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__map_detail_map_detail_component__["a" /* MapDetailComponent */])
    ...
    MapViewComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__shared_radar_service__["a" /* RadarService */]])
    ], MapViewComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__map_tooltip_map_tooltip_component__ = __webpack_require__("./src/app/main/map-tooltip/map-tooltip.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_color_service__ = __webpack_require__("./src/app/shared/color.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MapComponent = /** @class */ (function () {
    function MapComponent(ref, colorService, zone) {
        ...
        this.colorService = colorService;
        this.zone = zone;
        this.bubbleClickEvent = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.circleMarkers = [];
        this.arrowMarkers = [];
        this.map = null;
        this.options = {
            layers: [
                Object(__WEBPACK_IMPORTED_MODULE_1_leaflet__["tileLayer"])('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { attribution: '...' }),
            ],
            zoom: 14,
            center: Object(__WEBPACK_IMPORTED_MODULE_1_leaflet__["latLng"])(47.55814, 7.58769)
        };
    }
    ...
    MapComponent.prototype.createCircleMarkers = function () {
        ...
        this.data.forEach(function (d, index) {
            ...
            var i = Object(__WEBPACK_IMPORTED_MODULE_1_leaflet__["divIcon"])({
                html: "<svg width='12' height='12' class='svg-marker'>\n        <circle cx='7' cy='7' fill=\"" + color + "\" class='circle' r='7' id=circle" + index + "></circle>\n        </svg>"
            });
            mark = Object(__WEBPACK_IMPORTED_MODULE_1_leaflet__["marker"])([d.lat, d.long], {
                icon: i
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_2__map_tooltip_map_tooltip_component__["a" /* MapTooltipComponent */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__map_tooltip_map_tooltip_component__["a" /* MapTooltipComponent */])
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SelectCoordinatesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__ = __webpack_require__("./node_modules/@ng-bootstrap/ng-bootstrap/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_radar_service__ = __webpack_require__("./src/app/shared/radar.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SelectCoordinatesComponent = /** @class */ (function () {
    function SelectCoordinatesComponent(modalService, ref, radarService) {
        ...
        this.open = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.options = {};
        this.coordinates = new __WEBPACK_IMPORTED_MODULE_2_leaflet__["LatLng"](0, 0);
        this.markers = [];
    ...
    SelectCoordinatesComponent.prototype.setOptions = function () {
        this.options = {
            layers: [
                Object(__WEBPACK_IMPORTED_MODULE_2_leaflet__["tileLayer"])('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { maxZoom: 18, attribution: '...' }),
            ],
            zoom: 11,
            center: Object(__WEBPACK_IMPORTED_MODULE_2_leaflet__["latLng"])(47.55814, 7.58769)
        };
    };
    ...
    SelectCoordinatesComponent.prototype.onOpen = function (content) {
        ...
        this.setOptions();
        this.status = Status.initial;
        this.coordinates = new __WEBPACK_IMPORTED_MODULE_2_leaflet__["LatLng"](this.rowData.lat, this.rowData.long);
        this.addCoordinates(this.coordinates);
        this.status = Status.direction1;
        this.direction1 = new __WEBPACK_IMPORTED_MODULE_2_leaflet__["LatLng"](this.rowData.directionOneLat, this.rowData.directionOneLong);
        this.addCoordinates(this.direction1);
        this.status = Status.direction2;
        this.direction2 = new __WEBPACK_IMPORTED_MODULE_2_leaflet__["LatLng"](this.rowData.directionTwoLat, this.rowData.directionTwoLong);
    ...
    SelectCoordinatesComponent.prototype.addCoordinates = function (latLng) {
        ...
        var i = Object(__WEBPACK_IMPORTED_MODULE_2_leaflet__["divIcon"])({ html: "<svg width='15' height='15' class='svg-marker'>" +
                "<circle cx='7' cy='7' r='7' fill='" + color + "' class='circle'></circle>" +
                "</svg>" });
        var mark = Object(__WEBPACK_IMPORTED_MODULE_2_leaflet__["marker"])(latLng, {
            icon: i
        });
    ...
    SelectCoordinatesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["ApplicationRef"],
            __WEBPACK_IMPORTED_MODULE_3__shared_radar_service__["a" /* RadarService */]])
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        this.http = http;
        this.api = __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].api + 'auth/';
        this.adminSource = new __WEBPACK_IMPORTED_MODULE_3_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](false);
...
var ColorService = /** @class */ (function () {
    ...
    ColorService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_d3_ng2_service__["a" /* D3Service */]])
    ], ColorService);
    return ColorService;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RadarService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environments_environment__ = __webpack_require__("./src/environments/environment.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var RadarService = /** @class */ (function () {
    function RadarService(http) {
        this.http = http;
        this.api = __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].api + 'radar/';
    }
    ...
    RadarService.prototype.getRadarWithAvgSpeedAndSpeedingQuote = function () {
        return this.http.get(this.api + 'radarWithAvgSpeedAndSpeedingQuote2');
    };
...
var RecordService = /** @class */ (function () {
    function RecordService(http) {
        this.http = http;
        this.api = __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].api + 'record/';
    }
    ...
    RecordService.prototype.getRecordsForWeeklyView = function (radarId, direction, startDay, endDay) {
        return this.http.get(this.api + ("recordForWeeklyView?radarId=" + radarId + "&direction=" + direction + "\n    &startDay=" + startDay + "&endDay=" + endDay));
    };
    RecordService.prototype.getRecordsForDailyView = function (radarId, direction, startDay, endDay) {
        return this.http.get(this.api + ("recordForDailyView?radarId=" + radarId + "&direction=" + direction + "\n    &startDay=" + startDay + "&endDay=" + endDay));
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SailsClientService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_angular2_sails__ = __webpack_require__("./node_modules/angular2-sails/index.js");
...
var SailsClientService = /** @class */ (function () {
   ...
   */
    ...
    SailsClientService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_angular2_sails__["SailsService"]])
    ], SailsClientService);
