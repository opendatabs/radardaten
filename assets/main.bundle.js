...
var AdminComponent = /** @class */ (function () {
    ...
    AdminComponent.prototype.onUserRowSelect = function (event) {
        ...
        if (event.selected.length) {
            this.radarService.updateRecordCount(event.selected[0]).subscribe(function (res) { return console.log('Recordcount updated', res); }, function (err) { return console.error('Reocrdcount could not be updated', err); });
